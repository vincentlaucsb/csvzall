...
exports.computeMenuPosition = computeMenuPosition;
exports.resolveAxisPosition = resolveAxisPosition;
/**
 ...
 */
function computeMenuPosition(input) {
 ...
 */
function resolveAxisPosition(preferredStart, size, viewportSize, padding, fallbackStart) {
    const min = padding;
