# WASM Viewer Guidance

This file is the canonical AI reference for the experimental WASM CSV viewer.

`src/viewer_wasm/CLAUDE.md` must stay in sync with this file in the same commit.
